<%-- 
    Document   : approve
    Created on : 6 Δεκ 2013, 6:10:41 μμ
    Author     : NIKOS
--%>
...
<%
    ...
    statement.executeUpdate("update User set waitingApp='2' where customerCode='"+Long.parseLong(request.getParameter("customerCode")) +"'");
%>
<html>
        <title>winCell</title>
        <link rel="icon" 
    ...
    <meta http-equiv="REFRESH" content="0;url=manager.jsp#openModal"><b>
        <%} }else {
        %>
